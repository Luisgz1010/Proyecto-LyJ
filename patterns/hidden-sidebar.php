<?php
/**
* Title: Sidebar del proyecto
* Slug: mi-tema-proyecto/hidden-sidebar
 * Inserter: no
 */
?>
...
<div class="wp-block-group" style="padding-right:0;padding-left:0">
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
		...
		<div class="wp-block-group">
			...
			<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e( 'Sobre el proyecto', 'mi-tema-proyecto' ); ?></h2>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		...
		<!-- wp:navigation-link {"label":"<?php esc_html_e( 'PUTAS', 'twentytwentyfour' ); ?>","url":"#","className":"is-style-arrow-link","style":{"typography":{"textDecoration":"underline"}}} /-->
		<!-- /wp:navigation -->
	</div>
	<!-- /wp:group -->
